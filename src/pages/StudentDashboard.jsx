...
export default function StudentDashboard() {
          ...
          <section id="profile">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition duration-300 hover:shadow-2xl flex flex-col md:flex-row items-center gap-8">
              <div className="flex-shrink-0 flex flex-col items-center gap-4">
                <img className="w-32 h-32 rounded-full object-cover border-4 border-blue-200" src="https://i.pravatar.cc/150?u=a042581f4e29026704d" alt="Profile Picture" />
          ...
          <section id="exam">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition duration-300 hover:shadow-2xl space-y-6">
              ...
              <div>
                ...
                <textarea id="answer" rows="5" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" placeholder="Type your answer here..."></textarea>
              </div>
              <div className="flex justify-between items-center">
                <button className="px-6 py-2 font-semibold text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300">Previous Question</button>
                <button className="px-6 py-2 font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700">Next Question</button>
              </div>
            </div>
          </section>
        );
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition duration-300 hover:shadow-2xl">
              <form className="space-y-6">
                <div>
                  ...
                  <input type="text" id="issue-subject" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" placeholder="e.g., Error in result scorecard" />
                </div>
                <div>
                  <label htmlFor="issue-description" className="block text-sm font-medium text-gray-600 mb-2">Description</label>
                  <textarea id="issue-description" rows="5" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" placeholder="Please describe your issue in detail..."></textarea>
                </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200 hidden md:block"> {/* Hidden on mobile, visible on medium screens and up */}
